...
The DSN comes from ``Settings`` rather than ``alembic.ini`` so that the
application and the migrations cannot end up pointed at different databases.
"""
...
from scout_careers.db import models as _models
